...
"        stop:0.5 #00CC00, stop:0.66 #0000FF, stop:0.83 #4B0082, stop:1 #9400D3);\n"
"    border: 1px solid black;\n"
"    border-radius: 4px;\n"
"}\n"
"\n"
...
"QPushButton:pressed {\n"
"    background-color: qlineargradient(x1:0, y1:0, x2:1, y2:0.8,\n"
"        stop:0 #990000, stop:0.17 #994C00, stop:0.33 #999900,\n"
"        stop:0.5 #007A00, stop:0.66 #000099, stop:0.83 #2D004E, stop:1 #59007F);\n"
"    border: 2px solid #000;\n"
"}\n"
"\n"
"QPushButton:disabled {\n"
...
"}")
        ...
        self.edit_csv_path = QtWidgets.QLineEdit(parent=self.frame_2)
        self.edit_csv_path.setGeometry(QtCore.QRect(8, 1, 391, 20))
...
"}")
        ...
        self.button_csv_folder = QtWidgets.QPushButton(parent=self.frame_2)
        self.button_csv_folder.setEnabled(True)
        self.button_csv_folder.setGeometry(QtCore.QRect(9, 2, 25, 18))
        self.button_csv_folder.setStyleSheet("QPushButton {\n"
"    background-color: rgb(230, 230, 230);\n"
"    border-radius: 4px;\n"
"}\n"
"\n"
...
"    color: rgb(200,200,200);\n"
"}")
        self.button_csv_folder.setText("")
...
"    color: rgb(200,200,200);\n"
"}")
        self.button_purple.setText("")
        self.button_purple.setObjectName("button_purple")
        self.edit_csv_path2 = QtWidgets.QLineEdit(parent=self.frame_2)
        self.edit_csv_path2.setGeometry(QtCore.QRect(400, 1, 281, 20))
        self.edit_csv_path2.setStyleSheet("QLineEdit {\n"
"    background-color: rgb(253, 253, 253);\n"
"    padding-left: 2px;\n"
"}")
...
"}")
        ...
        self.table_csv.setVerticalScrollMode(QtWidgets.QAbstractItemView.ScrollMode.ScrollPerPixel)
